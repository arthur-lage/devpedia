          ...
          >
            <div className="flex flex-col">
              ...
              <div className="flex items-center flex-col gap-8 w-[40rem]">
                ...
                <button
                  type="submit"
                  className="w-full bg-pinkish-red-900 hover:brightness-150 transition-all duration-150 text-lg text-white rounded-md p-2 font-source-code-pro uppercase font-medium"
                >
                  Search
                </button>
              </div>
