  ...
  return (
    <div className="flex flex-col">
      ...
      <main className="mt-12 flex flex-col items-center justify-center">
        ...
        <Image className="w-[13rem] my-8" src={ReadingCode} alt="Person looking at code in a computer screen." />
        ...
        >
          ...
          <span className="text-white font-medium font-source-code-pro text-lg">Sign In</span>
        </SignInButton>
      </main>
    </div>
  );
